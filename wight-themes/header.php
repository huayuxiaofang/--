...
<body <?php body_class(); ?>>
	...
	<div id="page-wrap">
       ...
       <a class="logo"  href="<?php bloginfo('url'); ?> " > <img src="<?php bloginfo('template_url'); ?>/images/logo.png" /></a><!--logo-->
       
 
    <div class="seach_header">
     <p class="phone">TELL：<?php echo get_option('mytheme_tell'); ?> </p>
    ...
    <div>
      ...
      <div id="navigation">  <a  class="home"  href="<?php bloginfo('url'); ?> " class="logo"><img src="<?php bloginfo('template_url'); ?>/images/home_10.gif" /></a><?php wp_nav_menu(array( 'theme_location' => 'header-menu' ) ); ?></div>
